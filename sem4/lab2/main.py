...
def main():
    ...
    plt.title("Сравнение времени выполнения рекурсивного и нерекурсивного вариантов ")
    plt.xlabel("Размер списка (n)")
    plt.ylabel("Общее время выполнения (секунды)")

    # Строим графики для рекурсивной и нерекурсивной версий
    plt.plot(range(10, 101, 10), recursive_times, label="Рекурсивный вариант")
    plt.plot(range(10, 101, 10), iterative_times, label="Нерекурсивний вариант")
